...
class Bodega {
    ...
    renderMainView(parent) {
        ...
        this.renderHeader(parent, "Bodega", null, {"class": "nameplate"});
    ...
    renderTagView(parent) {
        ...
        this.renderHeader(parent, tag, [["/", "Bodega"], `Tag ${tag}`]);
    ...
    renderArtifactView(parent) {
        ...
        this.renderHeader(parent, artifactId, [["/", "Bodega"], [`/tags/${tag}`, `Tag ${tag}`], `Artifact ${artifactId}`]);
